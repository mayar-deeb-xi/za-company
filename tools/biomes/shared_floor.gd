extends RefCounted
## Floor 3 of THE NEW HIRE - the floor the call team and the media team share,
## and neither of them asked to.
##
## Data only, read by tools/biomes.gd; the key reference lives there.

const BIOME := {
	"node": "SharedFloor",
	"title": "THE SHARED FLOOR",
	...
	#
	# Grey-violet rather than the lobby's blue-grey or the bullpen's brown: a
	...
	"accent": "d9569d",
	# Just above 1.0, so mid-tones sit down: dimmer than the bullpen, and the
